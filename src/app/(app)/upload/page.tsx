...
export default async function UploadPage() {
  ...
  return (
        <div className="max-w-[1100px] mx-auto px-6 md:px-10 py-12 md:py-16">
              <div className="mb-10">
                      <div className="text-xs uppercase tracking-[0.3em] text-copper mb-3 font-mono">§ Processar</div>div>
                      <h1 className="font-display leading-[0.95] tracking-editorial" style={{ fontWeight: 300, fontSize: "clamp(36px, 5vw, 64px)" }}>
                                Sua próxima foto, <em className="italic text-copper">em alta resolução</em>em>.
                      </h1>h1>
              </div>div>

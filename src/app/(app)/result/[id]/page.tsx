    ...
    <div className="max-w-[1400px] mx-auto px-6 md:px-10 py-12 md:py-16">
      ...
      <div className="mb-8">
        ...
        <h1 className="font-display leading-[0.95] tracking-editorial mb-2" style={{ fontWeight: 300, fontSize: "clamp(32px, 4vw, 56px)" }}>
          {job.status === "completed" && (
            <>
              Sua imagem<br />
              <em className="italic text-copper">está pronta.</em>
            </>
          )}
          {job.status === "processing" && (
            <>
              Ainda <em className="italic text-copper">processando...</em>
            </>
          )}
        ...
        <>
          ...
          {originalUrl && (
            <div className="grid md:grid-cols-2 gap-4">
              <div>
                <div className="text-xs uppercase tracking-[0.25em] text-bone-dim mb-3 font-mono">Original</div>
              ...
              <div>
                <div className="text-xs uppercase tracking-[0.25em] text-copper mb-3 font-mono">Processado</div>
                ...
                <div className="mt-2 text-xs text-bone-dim font-mono">
                  {tier?.label} · até {tier?.maxDimension}px ·{" "}
      ...
      {job.status === "processing" && (
        <div className="border border-ink-line bg-ink-deep p-12 text-center">
          ...
          <p className="text-xs text-bone-dim font-mono">atualize a página em alguns segundos</p>
        </div>
      )}
